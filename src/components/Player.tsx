...
import { pauseCircle, playCircle, stopCircle } from 'ionicons/icons';
...
interface PlayerProps {
  musicFromSetlist?: Music;
}

const Player: React.FC<PlayerProps> = ({ musicFromSetlist }) => {
  ...
  useEffect(() => {
    // Carregar música se vier da lista ou setlist
    const music = musicFromSetlist || location.state?.music;
    if (music) {
